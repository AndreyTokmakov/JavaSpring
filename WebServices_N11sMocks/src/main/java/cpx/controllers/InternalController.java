...
public class InternalController {
    ...
    private boolean isHealthOK = true;

	public InternalController() {
		log.info(this.getClass().getSimpleName() + " created!");
	}
	
    @GetMapping("/health/balancer")
    public ResponseEntity<String> getHealthCheckForBalancer() {
    	log.info("InternalController::getHealthCheckForBalancer() called");
    	return ResponseEntity.status(isHealthOK ? 200: 503)
