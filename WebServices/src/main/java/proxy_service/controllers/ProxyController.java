...
public class ProxyController {
	...
	{
		log.info("* * * proxy_service.controllers.ProxyController::handleTestPathEx(" + ext_path + ") called * * *");
    ...
    {
		log.info("* * * proxy_service.controllers.ProxyController::getRequest(" + path + ") called * * *");
		...
		log.info("* * * proxy_service.controllers.ProxyController::getRequest: GET  " + request.getRequestLine());
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault();
			...
			log.info("* * * proxy_service.controllers.ProxyController::getRequest: " + response.getStatusLine().toString());
